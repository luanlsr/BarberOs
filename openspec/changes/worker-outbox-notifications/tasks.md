...
- [ ] 5.2 Implement durable job claiming, leases, Redis-backed locks and safe reclaim behavior, and verify worker tests cover concurrent claim attempts and expired leases.

...
> = {
  clientes: {
    ...
    emptyTitle: 'Ainda não ha clientes',
    emptyDescription: 'Cadastre o primeiro cliente ou crie um agendamento pela agenda.',
    deniedDescription: 'Seu perfil não pode visualizar clientes desta unidade.',
  ...
  equipe: {
    ...
    formDescription: 'Vincule a filial e deixe o profissional disponível para futuros horários.',
    emptyTitle: 'Equipe ainda vazia',
    emptyDescription: 'Adicione profissionais para montar a agenda operacional da filial.',
    deniedDescription: 'Seu perfil não pode visualizar equipe desta unidade.',
  ...
  servicos: {
    area: 'servicos',
    title: 'Serviços',
    eyebrow: 'Catálogo da agenda',
    description: 'Organize serviços, duração, preço e profissionais habilitados para atendimento.',
    searchPlaceholder: 'Buscar serviço ou categoria',
    primaryActionLabel: 'Novo serviço',
    formTitle: 'Novo serviço',
    formDescription: 'Defina nome, duração e preço usados nos agendamentos e futura Comanda.',
    emptyTitle: 'Nenhum serviço cadastrado',
    emptyDescription: 'Crie serviços para liberar seleção no fluxo de novo agendamento.',
    deniedDescription: 'Seu perfil não pode visualizar serviços desta unidade.',
...
const items: Record<OperationsDirectoryArea, OperationsDirectoryItem[]> = {
  clientes: [
    ...
    },
    {
      ...
      tags: ['Recepção', 'Primeiro atendimento'],
    },
  ],
  equipe: [
    {
      ...
      tags: ['Corte + barba', 'Comissão padrão'],
    },
    {
...
const fields: Record<OperationsDirectoryArea, OperationsDirectoryField[]> = {
  clientes: [
    ...
    },
    {
      ...
      type: 'select',
      options: ['Recepção', 'WhatsApp', 'Online', 'Indicação'],
    },
  ],
  equipe: [
    {
